...
public class AudioCUDP extends Thread {
	...
	private void initiateAudio() {
		try {
			//multicast mismo puerto servidor
			//this.inetaddres)=ineradrres.getbyname(direccion d)
			...
			while (true) {
				...
				//this.multicast.joingroup(inetaddrres)obj
